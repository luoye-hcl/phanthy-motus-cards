...
门禁检查通过:发布器 q5_body_command 可用,lifecycle=active,joint_state fresh,q5_fsm=READY。竞争发布者 mpc_policy_node。与 head_control 共享 body 发布器。

## 完整验收清单

- [x] MCP tools/list 确认工具 `arm_control` 已注册
