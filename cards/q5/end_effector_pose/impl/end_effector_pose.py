# -*- coding: utf-8 -*-
# end_effector_pose —— Q5 末端执行器位姿 (std_msgs/msg/Float32MultiArray)
# 自建 ROS2 Node 订阅 /mobile_manipulator/end_effector_pose，解析末端位置与姿态。
...
def build(msg, received_at_ms) -> dict:
    ...
    data = [float(v) for v in (msg.data or [])]
    return {"timestamp_ms": now_ms, "received_at_ms": received_at_ms,
    ...
    def __init__(self, plugin_config, namespace, executor, client):
        ...
        if _HAS_ROS2 and executor is not None:
            try:
                ...
                self._node.create_subscription(Float32MultiArray, SOURCE_TOPIC, self._on_msg, _QOS)
